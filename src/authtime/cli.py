...
def create_parser() -> argparse.ArgumentParser:
    ...
    report_parser.add_argument("--format", type=str, choices=["markdown", "json", "html"], default="markdown", help="Report output format.")
...
async def async_run_command(args):
    ...
    html_path = os.path.join(args.output_dir, f"{last_res.experiment_id}_report.html")
...
def main():
    ...
    if args.command == "run":
        ...
        print(f" Difference:           {res['diff_sec']:+.2f}s")
