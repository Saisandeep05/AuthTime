# Standalone Reproduction Script for AuthTime Finding: FIND-EXP-MAIN-1787487100-3
# Target: http://127.0.0.1:8000
# Fault Type: stale_cache
# Generated: 2026-08-23T17:41:46.561907
...
EXP_ID = "EXP-MAIN-1787487100-3"

# Enforce strict local loopback safety on reproduction script execution
parsed = urlparse(TARGET_URL)
if parsed.hostname not in ("127.0.0.1", "localhost", "::1"):
    raise RuntimeError(f"SAFETY ABORT: PoC target URL '{TARGET_URL}' is non-local loopback!")
