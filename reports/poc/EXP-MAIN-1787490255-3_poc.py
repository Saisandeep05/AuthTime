# Standalone Reproduction Script for AuthTime Finding: FIND-EXP-MAIN-1787490255-3
# Target: http://127.0.0.1:8000
# Fault Type: stale_cache
# Protocol Version: 1.0
# Generated: 2026-08-23T18:34:22.178850
        ...
        with httpx.Client(timeout=5.0, follow_redirects=False, trust_env=False) as client:
            try:
                ...
                for idx, offset in enumerate(PROBE_OFFSETS):
                    ...
                    is_viol, viol_reason = evaluate_authorization_violation(act_dec, "DENY", st_code, body_text, "/admin/users", DEFAULT_ADMIN_USERS_CONTRACT)
                ...
                try:
                    ...
                    if res_c.status_code == 200:
                        # Post-Cleanup Target State Verification
